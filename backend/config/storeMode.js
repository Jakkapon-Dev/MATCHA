...
export const isDemo = process.env.SHOP_MODE !== 'live';
export const DEMO_QUANTITY = 20;
export const demoCustomer = { firstName: 'Demo', lastName: 'Customer', email: 'demo@example.invalid', phone: '', address: 'ที่อยู่ตัวอย่าง ไม่มีการจัดส่ง', city: 'Demo City', state: '', zipCode: '00000', country: 'Thailand' };

export function demoProduct(source) {
...
export function demoRequest(body, rawKey, owner) {
...
export function validateDemoSelection(items, productMap) {
...
export default { isDemo, DEMO_QUANTITY, demoCustomer, demoProduct, demoRequest, validateDemoSelection };
