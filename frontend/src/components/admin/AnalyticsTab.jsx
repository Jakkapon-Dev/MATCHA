              ...
              <div className="p-6 rounded-2xl bg-white border border-matcha-border shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                  <div className="p-4 rounded-xl bg-matcha-bg border border-matcha-border">
                    <div className="text-xs font-mono text-matcha-muted">Paid Revenue</div>
                    <div className="text-2xl font-black text-matcha-primary font-mono mt-1">${totalRevenue.toLocaleString()}</div>
                  </div>
                  <div className="p-4 rounded-xl bg-matcha-bg border border-matcha-border">
                    <div className="text-xs font-mono text-matcha-muted">Estimated Profit Margin</div>
                    <div className="text-2xl font-black text-matcha-text font-mono mt-1">Not tracked</div>
                  </div>
                  <div className="p-4 rounded-xl bg-matcha-bg border border-matcha-border">
                    <div className="text-xs font-mono text-matcha-muted">Cart Conversion Rate</div>
                    <div className="text-2xl font-black text-matcha-accent font-mono mt-1">Not tracked</div>
                  </div>
                </div>
